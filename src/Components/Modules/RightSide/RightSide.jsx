...
const RightSide = ({ activeEl, counter, slide }) => {
      ...
      <div className="button__payment__block">
        ...
        <div className="bottom_elements">
          ...
          <div className="price__holder">
              <h1 className='total__value'>{totalPrice.toFixed(2)} PLN</h1>
            {secondMonthHide()}
          </div>

          <p className="slider__indicator">{counter} pracowników</p>
            <p className='worker__price'>{workCoef > 0 ? (totalPrice / workCoef).toFixed(2) : '0.00'} PLN / 1 PRACOWNIK MIESIĘCZNIE</p>
        </div>
